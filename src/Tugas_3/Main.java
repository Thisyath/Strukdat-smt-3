...
public class Main {
        ...
        while (running) {
            ...
            switch (choice) {
                case 1:
                    ...
                    runSort("Shell Sort", arr1, Shell::shellSort);
                    break;
                case 2:
                    int[] arr2 = Arrays.copyOf(originalSmall, smallSize);
                    runSort("Merge Sort", arr2, Merge::mergeSort);
                    break;
                case 3:
                    int[] arr3 = Arrays.copyOf(originalSmall, smallSize);
                    runSort("Quick Sort", arr3, (arr) -> Quick.quickSort(arr, 0, arr.length - 1));
                    break;
                case 4:
                    compareAll();
                    break;
    ...
    private static void compareAll() {
        int size = 10; // Ukuran array besar untuk pengukuran waktu
        Random rand = new Random();
